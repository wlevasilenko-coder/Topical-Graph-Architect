...
После установки спецификации лучше не продолжать бесконечную теоретическую доработку, а протестировать TGA на реальных сценариях:

1. **Full Cocoon Design** для новой темы с ограниченным набором ключей.
2. **Cocoon Audit** существующего раздела со sitemap, crawl, меню и SSoT-полями.
3. **Regulated Audit** для gambling, finance, medical или legal-проекта.
4. **Latent Intent Research** на query set, GSC и данных внутреннего поиска.

Практические кейсы быстрее выявят реальные пробелы, чем очередной кабинетный обзор спецификации.
